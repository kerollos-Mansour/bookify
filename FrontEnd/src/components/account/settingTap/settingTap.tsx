                ...
                <div key={field.label} className="space-y-4">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-3 flex-1">
                      <div className={`mt-1 p-2 rounded-lg ${field.destructive ? 'bg-red-100/10 text-red-600' : 'bg-muted text-muted-foreground'
                        }`}>
                        {field.icon}
                      </div>
                      <div className="flex-1">
                        ...
                        {field.value && (
                          <p className={`text-sm mt-1 ${field.destructive ? 'text-red-600' : 'text-muted-foreground'
                            }`}>
                            {field.value}
                          </p>
                        )}
                    ...
                    {/* Action Button */}
                    <button className={`text-sm font-medium px-4 py-2 rounded-lg border transition-colors ${field.destructive
                        ? 'text-red-600 border-red-300 hover:bg-red-50/10'
                        : 'text-blue-600 border-blue-300 hover:bg-blue-50/10'
                      }`}>
                      {field.destructive
                        ? 'Delete'

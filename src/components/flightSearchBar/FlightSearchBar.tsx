  ...
  useEffect(() => {
    ...
    return (
        <div className={`relative ${hideOnMobile ? "hidden md:block" : ""}`}>
            <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-0 bg-card rounded-xl lg:rounded-full shadow-lg dark:shadow-lg p-1.5 sm:p-2 lg:p-2 border border-card-border">
                {/* Origin */}
                <div
                    ref={originRef}
                    className="relative flex items-center gap-2 sm:gap-3 px-3 sm:px-4 md:px-5 lg:px-6 py-2.5 sm:py-3 md:py-3 flex-1 border-b lg:border-b-0 lg:border-r border-card-border cursor-pointer hover:bg-muted rounded-t-xl lg:rounded-t-none lg:rounded-l-full transition-colors"
                    onClick={() => {
                ...
                >
                    <MdFlightTakeoff className="text-xl sm:text-2xl text-muted-foreground shrink-0" />
                    ...
                    {showOriginDropdown && (
                        ...
                        >
                                ...
                                <div className="mb-4">
                                    ...
                                    {recentSearches
                                        ...
                                        .map((search) => (
                                            ...
                                            >
                                                <MdHistory className="w-4 h-4 text-muted-foreground shrink-0" />
                                                <div
                                                ...
                                                <button
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                                                        flightSearchStorage.remove(
                                                            search.id
                                                        );
                                                        setRecentSearches(
                                                            flightSearchStorage.get()
                                                        );
                                                    }}
                            ...
                            <div>
                                ...
                                {getFilteredAirports(originQuery).map(
                                    (airport) => (
                                        <div
                                            key={airport.code}
                                            onClick={() => {
                                        ...
                                        >
                                            <MdLocationOn className="w-5 h-5 text-muted-foreground shrink-0" />
                ...
                >
                    <MdFlightLand className="text-xl sm:text-2xl text-muted-foreground shrink-0" />
                    <div className="flex flex-col min-w-0 flex-1">
                        <label className="text-xs text-muted-foreground font-medium mb-1">
                            To
                        </label>
                    ...
                    {showDestinationDropdown && (
                        ...
                        >
                            ...
                            <div>
                                ...
                                {getFilteredAirports(destinationQuery).map(
                                    (airport) => (
                                        <div
                                            key={airport.code}
                                            onClick={() => {
            ...
            >
              <h3 className="font-semibold mb-4 text-card-foreground">
                ...
                <button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-3.5 rounded-xl md:rounded-full font-semibold transition-colors shrink-0 mt-2 md:mt-0 md:ml-2 shadow-md text-sm sm:text-base w-full md:w-auto"
                >
                    Search Flights
                </button>
            </div>

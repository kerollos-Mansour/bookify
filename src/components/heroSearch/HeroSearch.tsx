      ...
      <div className="relative z-10 pt-20 sm:pt-24 md:pt-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          ...
          <header className="text-center text-white">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-3 sm:mb-4 md:mb-6 drop-shadow-2xl leading-tight px-4">
              {CONTENT.title}
            </h1>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl max-w-md sm:max-w-2xl mx-auto opacity-90 drop-shadow-lg px-4 mt-2 sm:mt-4">
              {CONTENT.description}
            </p>
          </header>
        </div>

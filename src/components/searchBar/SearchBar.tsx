...
export function SearchBar({ hideOnMobile = false }: SearchBarProps) {
    ...
    return (
        <div className={`relative ${hideOnMobile ? "hidden md:block" : ""}`}>
            <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-0 bg-card rounded-xl lg:rounded-full shadow-lg dark:shadow-lg p-1.5 sm:p-2 md:p-2 border border-card-border">
                {/* Where to? */}
                <div
                    ref={locationRef}
                ...
                >
                    <MdLocationOn className="text-xl sm:text-2xl text-muted-foreground shrink-0" />
